...
mod bw6_761;
use bw6_761::{
	bench_msm_g2_bw6_761, bench_mul_affine_g1_bw6_761, bench_mul_affine_g2_bw6_761,
	bench_mul_projective_g1_bw6_761, bench_mul_projective_g2_bw6_761,
...
criterion_group! {
	...
	config = Criterion::default();
	targets =
	bench_pairing_arkworks_bls12_381, bench_msm_g1_bls12_381, bench_msm_g2_bls12_381, bench_mul_affine_g1_bls12_381,
	bench_mul_projective_g1_bls12_381, bench_mul_affine_g2_bls12_381, bench_mul_projective_g2_bls12_381,
}
...
criterion_group! {
	...
	config = Criterion::default();
	targets =
	bench_msm_g1_bw6_761, bench_msm_g2_bw6_761, bench_mul_affine_g1_bw6_761, bench_mul_projective_g1_bw6_761,
	bench_pairing_arkworks_bw6_761, bench_mul_affine_g2_bw6_761, bench_mul_projective_g2_bw6_761,
}
...
criterion_group! {
	...
	config = Criterion::default();
	targets =
	bench_msm_ed_on_bls12_377, bench_mul_affine_ed_on_bls12_377, bench_mul_projective_ed_on_bls12_377,
}
