...
pub use sp_ark_bls12_377::curves::{
...
pub fn do_msm_g1_optimized(
	...
	>],
	scalars: &[<sp_ark_bls12_377::g1::Config<sp_ark_bls12_377::curves::Host> as sp_ark_models::CurveConfig>::ScalarField],
) -> Result<(), Error> {
	let _out = <sp_ark_bls12_377::g1::Config<sp_ark_bls12_377::curves::Host> as sp_ark_models::short_weierstrass::SWCurveConfig>::msm(
		bases,
		scalars,
	);
	Ok(())
...
pub fn do_msm_g2_optimized(
	...
	>],
	scalars: &[<sp_ark_bls12_377::g2::Config<sp_ark_bls12_377::curves::Host> as ark_ec::CurveConfig>::ScalarField],
) -> Result<(), Error> {
	let _out = <sp_ark_bls12_377::g2::Config<sp_ark_bls12_377::curves::Host> as SWCurveConfig>::msm(
		bases, scalars,
	);
	Ok(())
}
...
pub fn do_mul_affine_g1_optimized(
	...
	let _out = <sp_ark_bls12_377::g1::Config<sp_ark_bls12_377::curves::Host> as sp_ark_models::short_weierstrass::SWCurveConfig>::mul_affine(
		base,
		scalar,
	);
	Ok(())
...
pub fn do_mul_projective_g1_optimized(
	...
	let _out = <sp_ark_bls12_377::g1::Config<sp_ark_bls12_377::curves::Host> as sp_ark_models::short_weierstrass::SWCurveConfig>::mul_projective(
		base,
		scalar,
	);
	Ok(())
...
pub fn do_mul_affine_g2_optimized(
	...
	let _out = <sp_ark_bls12_377::g2::Config<sp_ark_bls12_377::curves::Host> as sp_ark_models::short_weierstrass::SWCurveConfig>::mul_affine(
		base,
		scalar,
	);
	Ok(())
...
pub fn do_mul_projective_g2_optimized(
	...
	let _out = <sp_ark_bls12_377::g2::Config<sp_ark_bls12_377::curves::Host> as sp_ark_models::short_weierstrass::SWCurveConfig>::mul_projective(
		base,
		scalar,
	);
	Ok(())
